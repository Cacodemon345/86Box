...
#define TB_TO_PTB_FACTOR	8

#define PPC_MODEL "ppc_model"
#define PPC_CPU_MODEL "ppc_cpu"
#define PPC_CLOCK_FREQUENCY PPC_MHz(100)
#define PPC_BUS_FREQUENCY PPC_MHz(100)
#define PPC_TIMEBASE_FREQUENCY (PPC_BUS_FREQUENCY / TB_TO_PTB_FACTOR)
